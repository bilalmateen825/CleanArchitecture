...
namespace EZBooking.Application.Apartments.SearchApartments
{
    internal sealed class SearchApartmentsQueryHandler : IQueryHandler<SearchApartmentsQuery, IReadOnlyList<ApartmentResponse>>
    {
        ...
        public async Task<Result<IReadOnlyList<ApartmentResponse>>> Handle(SearchApartmentsQuery request, CancellationToken cancellationToken)
        {
            ...
            // Query<ApartmentResponse, AddressResponse, ApartmentResponse> interesting feature of dapper that allow us to query multiple objects from the database. 
            //We are quering for an apartment response and an address response and final result is an apartment response type.
